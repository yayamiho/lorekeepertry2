...
<p>You can choose and customize your games here </p>

<div class="text-right mb-3"><a class="btn btn-primary" href="{{ url('admin/arcade/create') }}"><i class="fas fa-plus"></i> Create New Game</a></div>
@if(!count($games))
    <p>No games found.</p>
@else
    {!! $themes->render() !!}
