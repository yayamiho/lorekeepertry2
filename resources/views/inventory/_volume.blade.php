<li class="list-group-item">
    <a class="card-title h5 collapse-title" data-toggle="collapse" href="#Volumeform"> Use {{ ucfirst(__('volumes.volume')) }}</a>
    <div id="Volumeform" class="collapse">
        {!! Form::hidden('tag', $tag->tag) !!}
        @php
            $volume = \App\Models\Volume\Volume::find($tag->getData()['volume_id']);
        @endphp
