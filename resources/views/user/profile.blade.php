    ...
    <div class="mb-4">
        <div class="row">
            ...
            <div class="row col-md-6">
                ...
                <div class="col-md-10 col-8" style="padding-right:0">{!! format_date($user->created_at, false) !!} ({{ $user->created_at->diffForHumans() }})</div>
            </div>
            <div class="row col-md-6">
                <div class="col-md-2 col-4" style="padding-right:0">
                    <h5>Rank</h5>
                </div>
                <div class="col-md-10 col-8" style="padding-right:0">{!! $user->rank->displayName !!} {!! add_help($user->rank->parsed_description) !!}</div>
            </div>
