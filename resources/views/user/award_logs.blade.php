...
@section('profile-title') {{ $user->name }}'s Award Logs @endsection

@section('profile-content')
{!! breadcrumbs(['Users' => 'users', $user->name => $user->url, 'awardcase' => $user->url . '/awardcase', 'Logs' => $user->url.'/award-logs']) !!}

<h1>
    {!! $user->displayName !!}'s Award Logs
</h1>
