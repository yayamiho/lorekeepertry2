<div id="rewardRowData" class="hide">
    <table class="table table-sm">
        <tbody id="rewardRow">
            <tr class="reward-row">
                <td>{!! Form::select('rewardable_type[]', ['Item' => 'Item', 'Pet'=>'Pet', 'Currency' => 'Currency', 'LootTable' => 'Loot Table', 'Raffle' => 'Raffle', 'Border' => 'Border'], null, ['class' => 'form-control reward-type selectize', 'placeholder' => 'Select Reward Type']) !!}</td>
    ...
    {!! Form::select('rewardable_id[]', $pet, null, ['class' => 'form-control pet-select', 'placeholder' => 'Select Pet']) !!}
    ...
    {!! Form::select('rewardable_id[]', $border, null, ['class' => 'form-control border-select', 'placeholder' => 'Select Border']) !!}
</div>