    ...
    <tbody id="rewardTableBody">
        @if($rewards)
            @foreach($rewards as $reward)
                <tr class="reward-row">
                    <td>{!! Form::select('rewardable_type[]', ['Item' => 'Item', 'Award' => 'Award', 'Currency' => 'Currency', 'LootTable' => 'Loot Table', 'Raffle' => 'Raffle'], $reward->rewardable_type, ['class' => 'form-control reward-type selectize', 'placeholder' => 'Select Reward Type']) !!}</td>
                    <td class="reward-row-select">
                        ...
                        {!! Form::select('rewardable_id[]', $awards, $reward->rewardable_id, ['class' => 'form-control item-select selectize', 'placeholder' => 'Select Award']) !!}
