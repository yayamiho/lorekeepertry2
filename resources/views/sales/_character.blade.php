    ...
    <div class="m-1">
        <div class="row">
            <div class="col-md-6 text-center align-self-center">
                <a href="{{ $character->character->url }}"><img src="{{ $loop->count == 1 ? $character->character->image->imageUrl : $character->character->image->thumbnailUrl }}" class="mw-100 img-thumbnail" alt="{{ $character->fullName }}" /></a>
            </div>
