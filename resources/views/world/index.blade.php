    ...
    <div class="col-md-6">
        <div class="card mb-4">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><a href="{{ url('world/species') }}">{{ ucfirst(__('lorekeeper.specieses')) }}</a></li>
				<li class="list-group-item"><a href="{{ url('world/subtypes') }}">{{ ucfirst(__('lorekeeper.subtypes')) }}</a></li>
