...
{
    if(!$isCharacter) return ['items', 'pets', 'pet_variants', 'awards', 'currencies', 'raffle_tickets', 'loot_tables', 'user_items', 'recipes', 'user_awards', 'characters', 'themes', 'areas','borders'];
