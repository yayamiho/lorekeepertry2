...
class AwardTag extends Model
{
    ...
    **********************************************************************************************/
    ...
    /**
     * Get the award that this tag is attached to.
     */
    ...
    **********************************************************************************************/
    ...
    {
        $tag = Config::get('lorekeeper.award_tags.' . $this->tag);
    ...
    {
        return Config::get('lorekeeper.award_tags.' . $this->tag.'.name');
    }
    ...
    {
        return url('admin/data/awards/tag/'.$this->award_id.'/'.$this->tag);
    }
    ...
    {
        $class = 'App\Services\Award\\'.str_replace(' ', '', ucwords(str_replace('_', ' ', $this->tag))).'Service';
        return (new $class());
    }
