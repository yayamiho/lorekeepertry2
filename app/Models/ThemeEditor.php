...
class ThemeEditor extends Model
{
     ...
     */
    protected $fillable = [
        'name', 'theme_id', 'title_color', 'nav_color', 'nav_text_color', 'header_image_display', 'header_image_url', 'logo_image_display', 'logo_image_url', 'background_color', 'background_image_url', 'background_size', 
